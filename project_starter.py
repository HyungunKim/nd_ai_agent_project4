...
order_agent = ToolCallingAgent(model=model,
                         ...
                         When processing order with this agent, you should provide the item_name, quantity, and total price for that item (This is usually generated by the quote agent).  
                         """,
                               max_tool_threads=1)
